...
git clone https://github.com/ibxbit/go-rest-api.git
...
replacement of the string `github.com/ibxbit/go-rest-api` in all of project files with the string `github.com/abc/xyz`.
